...
inf_growth_l2lm0 <- lm(formula = infected_growth_l2 ~ date, df0)
...
recovered_growth_l2lm0 <- lm(formula = recovered_growth_l2 ~ date, df0)
...
deceased_growth_l2lm0 <- lm(formula = deceased_growth_l2 ~ date, df0)
df0$deceased_growth_l2lm0 <- predict(deceased_growth_l2lm0, df0)
df0$deceased_growth_lm0 <- round(2 ^ df0$deceased_growth_l2lm0)
