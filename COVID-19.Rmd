...
cat(paste0('Нулевой прирост будет достигнут: ', find_y_intersect(p1$infected_rate_lm0)))
```
...
cat(paste0('Нулевой прирост будет достигнут: ', find_y_intersect(p1$deceased_rate_lm0)))
```
...
cat(paste0('Нулевой прирост будет достигнут: ', find_y_intersect(p2$infected_rate_lm0)))
```
...
cat(paste0('Нулевой прирост будет достигнут: ', find_y_intersect(p2$deceased_rate_lm0)))
```
