...
ggplot(df0) +
  geom_col(aes(date, removed), size = 0.75) +
  geom_point(aes(date, removed), color = 'brown', size = 0.75) +
  geom_line(aes(date, removed_lm0), color = 'brown', size = 0.25, linetype = 'dashed') +
  scale_x_date(breaks = pretty_breaks(10)) +
  labs(x = '', y = '') +
